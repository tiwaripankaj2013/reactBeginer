  ...
  return (
    <div className=" bg-green-900  flex justify-center items-center py-8">
      ...
      >
        ...
        >
          <h2 className=" text-green-700 font-mono text-4xl">Register Form</h2>
        </div>
        ...
        <div className="flex justify-between px-12 pb-6">
          <button className="bg-red-700 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
            Register
          </button>
