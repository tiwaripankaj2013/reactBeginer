  ...
  return (
    <header className=" bg-pink-300 py-4 px-8">
      <ul className="flex mx-6 container">
         ...
         <li className="p-1 text-blue-700 mr-1 px-8 text-xl"><NavLink className={(navData) => navData.isActive ? ' border-b-2 border-blue-900' :''} to="/users">Users
         <li className="p-1 text-blue-700 mr-1 px-8 text-xl"><NavLink className={(navData) => navData.isActive ? ' border-b-2 border-blue-900' :''} to="/usersList">Users List
         </NavLink></li>
         </NavLink></li>
         ...
         <li className="p-1 text-blue-700 mr-1 px-8 text-xl"><NavLink className={(navData) => navData.isActive ? ' border-b-2 border-blue-900' :''} to="/signup">Signup</NavLink></li>
